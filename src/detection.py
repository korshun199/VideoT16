...
from config.settings import apply_osd_settings, load_settings
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--settings", type=Path, default=Path("config/settings.json"), help="Файл настроек оператора")
...
def run(args: argparse.Namespace) -> int:
    ...
    inav_reader = None
    if args.inav_port:
        from src.msp import InavMspReader
    ...
    if args.drm:
        ...
        from src.framebuffer import FramebufferOutput
